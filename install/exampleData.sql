...
insert into news(title, datePosted,userId,content)
	values("Foreign policy priorities for Obama","2012-10-16T12:45:30",8,"Barack Obama has won reelection as America’s president. But while the economy – and avoiding the so-called fiscal cliff – 
...
insert into news(title, datePosted,userId,content)
	values("Muamba was in effect dead for 78 minutes despite 15 heart shocks","2012-08-10T17:51:10",9,"Bolton Wanderers midfielder Fabrice Muamba did not respond to 15 defibrillator shocks and 
...
insert into news(title, datePosted,userId,content)
	values("Opera singers are athletes","2012-10-26T16:38:01",8,"Anita Hartig, 29, has just debuted at La Scala in Milan in the role of Mimi in Puccini's much-loved La Boheme. The Romanian soprano rose to fame after a critic mentioned her to Ioan Holender when 
		he was the musical director of the Vienna State Opera.");

insert into news(title, datePosted,userId,content)
	values("Golden boxer reveals her secret","2012-10-29T12:38:35",9,"Nicola Adams, 29, is the first ever Olympic gold medalist in women's boxing. In front of a home crowd at the London 2012 Olympics, she fought her way past a year-long injury to knock down Chinese boxer Ren Cancan in the final. 
