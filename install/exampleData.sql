...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Eurozone slides into recession","eurozone-slides-into-recession","2012-10-03T14:32:01",1,7,"The eurozone has returned to recession as the region's debt crisis continues to hurt demand, figures show.
...
insert into news(title, url,datePosted,categoryId,userId,content)
	values("Breakfast, lunch and dinner: Have we always eaten them?","breakfast-lunch-dinner","2012-11-04T08:17:05",2,7,
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Is Zlatan's wonder strike the best goal ever scored?","best-goal-ever-scored","2012-11-01T18:54:12",3,7,"Zlatan Ibrahimovic has dominated backpages all over the world since scoring an audacious overhead kick in 
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Can Twitter help save Spanish soccer club Real Oviedo?","club-real-oviedo","2012-09-05T11:02:56",4,7,"In an age when Russian oligarchs and Arab Sheikhs spend billions of dollars on forging the perfect dream team, 
...
insert into news(title, url,datePosted,categoryId,userId,content)
	values("Spanish banks stop evictions for the next 2 years","spanish-bank-stop","2012-03-01T20:31:07",1,7,"Spaniards who are in circumstances of extreme necessity and are unable to pay their mortgages will not be evicted from their 
		homes over the next two years, the main industry group for Spanish banks said Monday.");

insert into news(title, url, datePosted,categoryId,userId,content)
	values("After months of mystery, China unveils new top leaders","china-unveils-news-top-leaders","2012-10-09T04:32:08",2,8,"China on Thursday unveiled the elite group of leaders who will set the agenda for the country for the next decade, 
		the culmination of months of secretive bargaining and a carefully choreographed performance of political pomp.");

insert into news(title, url, datePosted,categoryId,userId,content)
	values("Foreign policy priorities for Obama","priorities-for-obama","2012-10-16T12:45:30",3,8,"Barack Obama has won reelection as America’s president. But while the economy – and avoiding the so-called fiscal cliff – 
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Who was the best foreign policy president?","best-foreign-president","2012-09-19T18:12:56",4,8," Both for his leadership turning one of our country’s moments of greatest vulnerability into the triumph of World War II, 
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Time to Say Danke","time-to-say-danke","2012-10-03T19:22:55",1,8,"Everyone is worried that Greece will default on its national debt. That's really not news. By one estimate, since it gained its independence from the Ottomans in 1832, 
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Reading While Eating for Nov. 15: State of the Union","reading-while-eating-state-of-the-union","2012-08-14T21:00:38",2,8,"Secessionists, Unite! More than half a million people from all 50 states have signed on to the 
...
");
	...
	insert into news(title, url, datePosted,categoryId,userId,content)
	values("$800 million biotech business started in a garage","business-started-in-garage","2012-03-03T00:11:18",3,9,"Bangalore, India (CNN) -- As one of India's richest self-made women, Kiran Mazumdar-Shaw has an impressive 
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("From muse to moneymaker","from-muse-to-moneymaker","2012-04-23T15:38:46",4,9,"From Warhol's silkscreens of Marilyn Monroe to Picasso's nudes, it has generally been easier for women to be the 
		subject of paintings than to have their own work exhibited.");

insert into news(title, url, datePosted,categoryId,userId,content)
	values("Cristiano Ronaldo and Daniel Craig - A right to privacy?","a-right-to-privacy","2012-11-04T16:22:56",1,9,"Both men have their photos plastered across billboards worldwide, their pictures on television 
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Muamba was in effect dead for 78 minutes despite 15 heart shocks","muamba-dead-for-78-minutes","2012-08-10T17:51:10",2,9,"Bolton Wanderers midfielder Fabrice Muamba did not respond to 15 defibrillator shocks and 
		was in effect dead for 78 minutes before his heart started beating again, doctors who treated him have revealed.");

insert into news(title, url, datePosted,categoryId,userId,content)
	values("America's black cowboys fight for their place in history","america-black-cowboys","2012-10-08T11:26:17",3,9,"Jason Griffin straps his right arm in bandages, preparing himself to grip the reins a wildly bucking bronco. Tall, broad-shouldered, 
		with a rough beard, he steps into his cowboy boots, fits a Stetson hat and heads out to meet his mount in the rodeo arena.");

	insert into news(title, url, datePosted,categoryId,userId,content)
	values("Chinese sculptor Xiang Jing's painful search for truth","chinese-sculptor-xiang","2012-09-07T08:48:45",4,8,"Her work has been exhibited in America and throughout Europe. She was the subject of a recent joint survey show at the Museum of Contemporary Art Shanghai. 
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Opera singers are athletes","opera-singers-are-athletes","2012-10-26T16:38:01",1,8,"Anita Hartig, 29, has just debuted at La Scala in Milan in the role of Mimi in Puccini's much-loved La Boheme. The Romanian soprano rose to fame after a critic mentioned her to Ioan Holender when 
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Clouds on horizon for tobacco farmers","clouds-on-horizon-for-tobacco","2012-10-06T16:59:17",3,9,"Government officials and health experts from around the world are meeting this week in South Korea to discuss a series of proposals that could put 
...
insert into news(title, url, datePosted,categoryId,userId,content)
	values("Oil search fuels tension over Lake Malawi","fuels-tension-over-lake-malawi","2012-07-03T18:32:07",4,7,"Lake Malawi, Malawi (CNN) -- Following recent oil finds in Uganda and Kenya, Malawi hopes to be the next East African country to strike black gold.
