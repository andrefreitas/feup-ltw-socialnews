...
insert into news(title, datePosted,userId,content)
	values("Eurozone slides into recession","2012-10-3 14:32",7,"The eurozone has returned to recession as the region's debt crisis continues to hurt demand, figures show.
...
insert into news(title, datePosted,userId,content)
	values("Breakfast, lunch and dinner: Have we always eaten them?","2012-11-4 8:17",7,
...
insert into news(title, datePosted,userId,content)
	values("Is Zlatan's wonder strike the best goal ever scored?","2012-11-1 18:54",7,"Zlatan Ibrahimovic has dominated backpages all over the world since scoring an audacious overhead kick in 
...
insert into news(title, datePosted,userId,content)
	values("Can Twitter help save Spanish soccer club Real Oviedo?","2012-9-5 11:02",7,"In an age when Russian oligarchs and Arab Sheikhs spend billions of dollars on forging the perfect dream team, 
...
insert into news(title, datePosted,userId,content)
	values("Spanish banks stop evictions for the next 2 years","2012-3-1 20:31",7,"Spaniards who are in circumstances of extreme necessity and are unable to pay their mortgages will not be evicted from their 
		homes over the next two years, the main industry group for Spanish banks said Monday.");

insert into news(title, datePosted,userId,content)
	values("After months of mystery, China unveils new top leaders","2012-10-9 4:32",8,"China on Thursday unveiled the elite group of leaders who will set the agenda for the country for the next decade, 
		the culmination of months of secretive bargaining and a carefully choreographed performance of political pomp.");

insert into news(title, datePosted,userId,content)
	values("Foreign policy priorities for Obama","2012-10-16 12:45",8,"Barack Obama has won reelection as America’s president. But while the economy – and avoiding the so-called fiscal cliff – 
...
insert into news(title, datePosted,userId,content)
	values("Who was the best foreign policy president?","2012-9-19 18:12",8," Both for his leadership turning one of our country’s moments of greatest vulnerability into the triumph of World War II, 
...
insert into news(title, datePosted,userId,content)
	values("Time to Say Danke","2012-10-3 19:22",8,"Everyone is worried that Greece will default on its national debt. That's really not news. By one estimate, since it gained its independence from the Ottomans in 1832, 
...
insert into news(title, datePosted,userId,content)
	values("Reading While Eating for Nov. 15: State of the Union","2012-8-14 21:00",8,"Secessionists, Unite! More than half a million people from all 50 states have signed on to the 
...
");
	...
	insert into news(title, datePosted,userId,content)
	values("$800 million biotech business started in a garage","2012-3-3 0:11",9,"Bangalore, India (CNN) -- As one of India's richest self-made women, Kiran Mazumdar-Shaw has an impressive 
...
insert into news(title, datePosted,userId,content)
	values("From muse to moneymaker","2012-4-23 15:38",9,"From Warhol's silkscreens of Marilyn Monroe to Picasso's nudes, it has generally been easier for women to be the 
		subject of paintings than to have their own work exhibited.");

insert into news(title, datePosted,userId,content)
	values("Cristiano Ronaldo and Daniel Craig - A right to privacy?","2012-11-4 16:22",9,"Both men have their photos plastered across billboards worldwide, their pictures on television 
...
insert into news(title, datePosted,userId,content)
	values("Muamba was in effect dead for 78 minutes despite 15 heart shocks","2012-08-10 17:51",9,"Bolton Wanderers midfielder Fabrice Muamba did not respond to 15 defibrillator shocks and 
		was in effect dead for 78 minutes before his heart started beating again, doctors who treated him have revealed.");

insert into news(title, datePosted,userId,content)
	values("America's black cowboys fight for their place in history","2012-10-8 11:26",9,"Jason Griffin straps his right arm in bandages, preparing himself to grip the reins a wildly bucking bronco. Tall, broad-shouldered, 
		with a rough beard, he steps into his cowboy boots, fits a Stetson hat and heads out to meet his mount in the rodeo arena.");

	insert into news(title, datePosted,userId,content)
	values("Chinese sculptor Xiang Jing's painful search for truth","2012-9-7 8:48",8,"Her work has been exhibited in America and throughout Europe. She was the subject of a recent joint survey show at the Museum of Contemporary Art Shanghai. 
...
insert into news(title, datePosted,userId,content)
	values("Opera singers are athletes","2012-10-26 16:38",8,"Anita Hartig, 29, has just debuted at La Scala in Milan in the role of Mimi in Puccini's much-loved La Boheme. The Romanian soprano rose to fame after a critic mentioned her to Ioan Holender when 
		he was the musical director of the Vienna State Opera.");

insert into news(title, datePosted,userId,content)
	values("Golden boxer reveals her secret","2012-10-29 12:38",9,"Nicola Adams, 29, is the first ever Olympic gold medalist in women's boxing. In front of a home crowd at the London 2012 Olympics, she fought her way past a year-long injury to knock down Chinese boxer Ren Cancan in the final. 
		Here she reveals how she fell in love with the sport and her heartache when she almost couldn't carry on");

insert into news(title, datePosted,userId,content)
	values("Clouds on horizon for tobacco farmers","2012-10-6 16:59",9,"Government officials and health experts from around the world are meeting this week in South Korea to discuss a series of proposals that could put 
...
insert into news(title, datePosted,userId,content)
	values("Oil search fuels tension over Lake Malawi","2012-7-3 18:32",7,"Lake Malawi, Malawi (CNN) -- Following recent oil finds in Uganda and Kenya, Malawi hopes to be the next East African country to strike black gold.
...
insert into tag(name) values("olympics");
insert into tag(name) values("america");
...
insert into comment(userId,newsId,content,datePosted) 
	values(1,1,"I total agree with that","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(1,1,"I think the editor should be more clear in this","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(1,1,"No wonder this happens a lot","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(2,2,"Music is for everyone","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(2,2,"Why them don't have privacy???","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(2,2,"Fuel is very bad, use clean energy!","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(1,3,"I didn't like this post","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(1,3,"Obama is a good president","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(3,3,"People lie a lot in news","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(4,4,"I like cookies","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(4,4,"When this happened?","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(4,4,"I think the problem is with the world","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(5,5,"Money is all that matters.. whatever","2012-12-10 15:23");

insert into comment(userId,newsId,content,datePosted) 
	values(2,5,"I want to be famous too","2012-08-10 11:25");

insert into comment(userId,newsId,content,datePosted) 
	values(2,5,"Singers have good voices (captain obvious strikes again)","2012-11-20 15:23");
